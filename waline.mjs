const e = ["nick", "mail"]
  ...
  , r = "en-US"
  , l = ["https://unpkg.com/browse/@waline/emojis@1.1.0/qq/qq_grin.gif", "//unpkg.com/@waline/emojis/tieba/tieba_look_down.png", "//unpkg.com/@waline/emojis/tieba/tieba_sunglasses.png", "//unpkg.com/@waline/emojis/tieba/tieba_pick_nose.png", "//unpkg.com/@waline/emojis/tieba/tieba_awkward.png", "//unpkg.com/@waline/emojis/tieba/tieba_sleep.png"]
  , i = e=>new Promise(((t,n)=>{
    if (e.size > 128e3)
...
var f = h(["昵称 Nickname", "Nickname cannot be less than 3 bytes.", "邮箱(可选) Email(optional)", "Please confirm your email address.", "网址(可选) Website(optional)", "Optional", "评论 Comment here", "暂无评论 No comment yet.", "提交评论 Submit", "喜欢 Like", "取消喜欢 Cancel like", "回复 Reply", "取消回复 Cancel reply", "", "刷新 Refresh", "加载更多 Load More...", "预览 Preview", "表情 Emoji", "上传图片 Upload Image", "seconds ago", "minutes ago", "hours ago", "days ago", "just now", "上传中 Uploading", "Login", "logout", "Admin", "Sticky", "Words", "Please input comments between $0 and $1 words!\n Current word number: $2", "匿名 Anonymous", "Dwarves", "Hobbits", "Ents", "Wizards", "Elves", "Maiar", "GIF", "Search GIF", "Profile", "Approved", "Waiting", "Spam", "Unsticky", "从旧到新 Oldest", "从新到旧 Latest", "最热 Hottest", "对这篇文章的看法 What do you think?"])
